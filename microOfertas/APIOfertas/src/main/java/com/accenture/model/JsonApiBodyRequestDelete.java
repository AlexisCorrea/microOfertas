...
public class JsonApiBodyRequestDelete   {
  @JsonProperty("oferta")
  @Valid
  private List<DeleteRequest> oferta = new ArrayList<DeleteRequest>();

  public JsonApiBodyRequestDelete oferta(List<DeleteRequest> oferta) {
    this.oferta = oferta;
    return this;
  }

  public JsonApiBodyRequestDelete addOfertaItem(DeleteRequest ofertaItem) {
  ...
  **/
  ...
  public List<DeleteRequest> getOferta() {
    return oferta;
  }

  public void setOferta(List<DeleteRequest> oferta) {
    this.oferta = oferta;
  }
